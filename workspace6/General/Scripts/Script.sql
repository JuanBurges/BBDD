...
ALTER TABLE ventas DROP CONSTRAINT `venta_articulo`;
ALTER TABLE ventas DROP id_articulo;
ALTER TABLE ventas ADD id_venta INT AUTO_INCREMENT not null PRIMARY KEY;
ALTER TABLE ventas ADD id_articulo INT(9) not null;
ALTER TABLE ventas ADD CONSTRAINT `ventas_articulos` FOREIGN KEY (id_articulo) REFERENCES articulos(Codigo);
